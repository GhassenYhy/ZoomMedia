...
        timedReturn?: boolean;
        ...
        /**
         * Optional URI to direct a detail to when a click occurs while clip is active
         *
         */
        clickThrough?: string;
...
declare module amp.Player {
    ...
    interface Source {
        ...
        /**
         * Set of track objects embedded to the given source.
         */
    ...
    interface Track {
        ...
        /**
         * Label attribute to create a detail readable title for the track. [label](http://www.w3.org/html/wg/drafts/html/master/semantics.html#attr-track-label)
         */
        label: string;
    ...
    /**
     * Track object to hold the embedded text track information in [[amp.Player.src]]
     */
    interface EmbeddedTrack {

        /**
         * Format or type of the embedded text track (Currently, supported only CEA608).
         */
        format: string;
        ...
        /**
         * The closed captions channel like CC1, CC2 etc.
         */
        channel: string;
    ...
    interface PlaybackSpeedOptions {
         ...
         * Every element in the levels array specify name/value pair for the playback speed choice that will be available in the detail selection menu.
